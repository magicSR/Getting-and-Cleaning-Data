...
data_label_1 = data_label[,-ncol(data_label)]
tidy_d_set = aggregate(. ~subject_ID + data_ID, data = data_label_1, mean)
tidy_d_set = tidy_d_set[order(tidy_d_set$subject_ID, tidy_d_set$data_ID),]
